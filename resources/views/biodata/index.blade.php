                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8">
                                        <span
                                            class="fw-bold fs-6 text-gray-800">{{ $siswa?->identitas?->no_ijazah }}</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8">
                                        <span
                                            class="fw-bold fs-6 text-gray-800">{{ $siswa?->identitas?->berat_badan }}</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <div class="row mb-7">
                        ...
                        <div class="row">
                            <div class="col-md-6 pe-10">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8">
                                        <span
                                            class="fw-bold fs-6 text-gray-800">{{ $siswa->orangTua?->no_telp_ayah }}</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                            </div>
                            <div class="col-md-6 pe-10">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8">
                                        <span
                                            class="fw-bold fs-6 text-gray-800">{{ $siswa->orangTua?->pekerjaan_ibu }}</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <div class="row mb-7">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-8">
                                        <span
                                            class="fw-bold fs-6 text-gray-800">{{ $siswa->orangTua?->no_telp_ibu }}</span>
                                    </div>
                                    <!--end::Col-->
                                </div>
                            </div>
